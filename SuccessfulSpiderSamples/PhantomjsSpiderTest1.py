...
def constructURL(lng, lat, Inc):
    BEGIN_URL = 'https://m.weibo.cn/p/index?containerid=2304410021' + str(lng) + '_' + str(lat) + '_&needlocation=1&uid=&count=10&page=1&luicode=&lfid=&featurecode='
...
if __name__ == "__main__":
    ...
    BEGIN_URL, lng, lat = constructURL(lng, lat, Inc)
