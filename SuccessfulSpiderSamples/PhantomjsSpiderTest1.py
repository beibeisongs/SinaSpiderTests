...
def catchFromScipt(html_script, HTML_data):
    ...
    if not (weibo_page_title == []) or (weibo_page_title[0] == ''):
    ...
    if (len(cards) > 0):
        for j in range(len(cards)):
            ...
            if (card_type == 9):
                ...
                created_at = mblog.get('created_at')  # 微博创建时间
...
def get_weibo(id, file):
    ...
    while process_mark:
        ...
        try:
            ...
            print("---Now use input to Stop this process---")
            process_mark = input()
...
def configDriver():
    ...
    dcap["phantomjs.page.settings.userAgent"] = ("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.221 Safari/537.36 SE 2.X MetaSr 1.0")
...
if __name__ == "__main__":
    ...
    BEGIN_URL = 'https://m.weibo.cn/p/index?containerid=2304410021114.305248_30.60786_&needlocation=1&uid=&count=10&page=1&luicode=&lfid=&featurecode='
